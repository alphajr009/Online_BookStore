    ...
    <div class="header">
        <div class="container">
            ...
            <div class="small-container single-product">
                <div class="row">
                    <div class="col-2">
                        <img src="images/Book 10.jpg" alt="Book10" width="68%" />
                    </div>
                    <div class="col-2">
                        <p>Home / Ebook</p>
                        ...
                        <br>
                        <h3>96% liked this book</h3><br>
                        <p>Harry Potter and the Philosopher's Stone is a fantasy novel written by British author J. K.
                            Rowling
                            <br><br>
                            Originally published: June 26, 1997<br><br>
                            Followed by: Harry Potter and the Chamber of Secrets<br><br>
