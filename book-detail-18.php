...
<html lang="en">
  ...
  <body>
    ...
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <img src="images/Book 23.jpg" alt="Book23" width="68%" />
        </div>
        <div class="col-2">
          <p>Home / New & Coming soon</p>
          <h3>TREASURING THE PSALMS</h3>
          <h4>Rs.1,000.00</h4>
          <h3>Book Details <i class="fa fa-indent"></i></h3><br>
		  <h3>How to Read the Songs that Shape the Soul of the Church</h3><br>
		  by Ian J. Vaillancourt<br><br>
		  <p>
