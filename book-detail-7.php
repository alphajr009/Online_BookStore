    ...
    <div class="header">
        <div class="container">
            ...
            <div class="small-container single-product">
                <div class="row">
                    <div class="col-2">
                        <img src="images/Book 11.jpg" alt="Book11" width="68%" />
                    </div>
                    <div class="col-2">
                        <p>Home / Ebook</p>
                        <h3>රොබින් ෂර්මා ඒ අපූරු මග – E Apuru Maga</h3>
                        <h4>Rs.950.00</h4>
                        ...
                        <br>
                        <h3>( විශිෂ්ට නායකයන්ගේ පිළිවෙත් 8 )</h3><br>
                        <p>ජීවිතයේ විශාලම දුක් ගැහැටවලට මුහුණ දෙන්නේ ද, සෙසු අයට විශාලම හානියක් සිදු කරන්නේ ද, තම සහෝදර
                            ජනයා ගැන සැලකිල්ලක් නොදක්වන මිනිසුන්ය. සියලූ මානව පරාජයන් පැන නැෙඟන්නේ එබඳු පුද්ගලයන්
                            තුළිනි.
                            <br>
                            - ඇල්ෆ‍්‍රඞ් ඇඞ්ලර්
                        </p>
