    ...
    <div class="header">
        <div class="container">
            ...
            <div class="small-container single-product">
                <div class="row">
                    <div class="col-2">
                        <img src="images/Book 18.jpg" alt="Book18" width="68%" />
                    </div>
                    <div class="col-2">
                        <p>Home / Ebook</p>
                        <h3>Parents in Pain</h3>
                        <h4>Rs.1,450.00</h4>
                        <input type="number" value="1" />
                        <button class="btn" style='border:none' onclick="addCart('<?php echo $itemID; ?>')">Add to
                            Cart</button>
                        <h3>Book Details <i class="fa fa-indent"></i></h3>
                        <h3>Parents in Pain</h3><br>
                        by John White<br>
                        Published: June 22, 1979<br>
                        A wallet disappears from your dresser and you're sure who took it--at least, somewhat sure.<br>
                        Many parents face problems beyond their ability to cope. John White ofers comfort to parents of
                        children with severe problems--alcoholism, homosexuality, even suicide. Though he gives
                        practical suggestions, this is not a how-to manual for making rebellious children behave. Rather
                        the author helps all parents deal with their own guilt, frustration, anger and sense of
                        inadequacy.<br><br>
                        <br> White first asks, Why has the child rearing become such a complicated task? He looks to
                        common sense, science and the Bible for an answer. Next he focuses on the parent-child
                        relationship itself as trust erodes, arguments arise and the need for professional or legal
                        counsel develops. Finally, he cautions us to avoid parenting techniques which emphasize
                        pragmatism at the expense of what is moral and just.
                        </p>
