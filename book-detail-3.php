    ...
    <div class="header">
        <div class="container">
            ...
            <div class="small-container single-product">
                <div class="row">
                    <div class="col-2">
                        <img src="images/Book 7.jpg" alt="Book7" width="68%" />
                    </div>
                    <div class="col-2">
                        <p>Home / Ebook</p>
                        <h3>THE HOBBIT</h3>
                        ...
                        <br>
                        <p>The Hobbit, or There and Back Again is a children's fantasy novel by English author J. R. R.
                            Tolkien. It was published in 1937 to wide critical acclaim, being nominated for the Carnegie
                            Medal and awarded a prize from the New York Herald Tribune for best juvenile fiction.
                            <br>
                            Originally published: September 21, 1937<br>
                            Author: J. R. R. Tolkien<br>
                            Characters: Bilbo Baggins, Gandalf, Thorin Oakenshield, Gollum, MORE
                        </p>
