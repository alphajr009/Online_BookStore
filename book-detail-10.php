    ...
    <div class="header">
        <div class="container">
            ...
            <div class="small-container single-product">
                <div class="row">
                    <div class="col-2">
                        <img src="images/Book 14.jpg" alt="Book14" width="68%" />
                    </div>
                    <div class="col-2">
                        <p>Home / Ebook</p>
                        <h3>CAN YOU JUST SIT WITH ME</h3>
                        <h4>Rs.1,050.00</h4>
                        <input type="number" value="1" />
                        <button class="btn" style='border:none' onclick="addCart('<?php echo $itemID; ?>')">Add to
                            Cart</button>
                        <h3>Book Details <i class="fa fa-indent"></i></h3>
                        <h3>Can You Just Sit with Me?</h3><br>
                        Healthy Grieving for the Losses of Life<br>
                        by Natasha Smith<br><br>
                        <p>>> Christian Living<br>
                            >> Death & Grief<br>
                            >> Christian Living<br>
                            >> Depression & Anxiety
                            <br><br>Published: September 26, 2023
                        </p>
